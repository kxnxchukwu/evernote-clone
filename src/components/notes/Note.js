...
import { deleteNote, taggleFavorite } from '../../store/actions/noteAction';
...
const Note = ({note}) => {
  ...
  return (
    ...
    <i className="material-icons" style={{cursor: "pointer"}} onClick={deletNoteHandler}>delete</i>
    </div>
